                ...
                <div className='footer-content1'>
                  ...
                  <div className='footer-address'>
                    ...
                    <div>
                      <p> Kondapur  Clinic</p>
                      <p>
                        5th Floor, Above Sachdev Sports,
                        Sri Tirumala Subash Arcade,
                        Kondapur X Roads, Kothaguda,
                  ...
                  <div className='footer-address'>
                    ...
                    <div>
                      ...
                      <p>
                        RISE Commercial Complex, 3rd Floor,
                        Over Van Lavino Cafe,
                        Opp. to APARNA SAROVAR GRANDE,
                        Nallagandla,Telangana 500019.</p>
                    </div>
                  </div>
              ...
              <div className="col-md-3">
                <div className="footer-links">
                  ...
                  <ul>
                    ...
                    <li><a href="#">PRP/Growth Factor treatment
                    </a></li>
                    <li><a href="#">Robotic Joint Replacement
                    </a></li>
                    <li><a href="#"> Joint Replacement
                    </a></li>
                    <li><a href="#">Sports Medicine</a></li>
                    <li><a href="#"> General Orthopaedics
                    </a></li>
                    <li><a href="#">Advanced Physiotherapy</a></li>
                  </ul>
                </div>
              </div>
              <div className="col-md-3">
